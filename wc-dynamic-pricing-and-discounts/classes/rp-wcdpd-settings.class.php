...
class RP_WCDPD_Settings
{
    ...
    public function maybe_display_migration_notice()
    {
        ...
        if ($notice = get_option('rp_wcdpd_migration_notice')) {
            ...
            // Print
            printf('<div class="update-nag rp_wcdpd_migration_notice"><h3>Action Required!</h3>' . $notice . '<p>Contact Support&nbsp;&nbsp;&nbsp;<a href="%s">Hide this notice</a></p></div>', add_query_arg('rp_wcdpd_hide_migration_notice', '1'));
        ...
        if ($notice = get_option('rp_wcdpd_migration_notice_products_to_adjust')) {
            ...
            // Print
            printf('<div class="update-nag rp_wcdpd_migration_notice"><h3>Warning!</h3>' . $notice . '<p>Contact Support&nbsp;&nbsp;&nbsp;<a href="%s">Hide this notice</a></p></div>', add_query_arg('rp_wcdpd_hide_migration_notice_products_to_adjust', '1'));
        ...
        if ($notice = get_option('rp_wcdpd_migration_notice_2021_09_security')) {
            ...
            // Print
            printf('<div class="update-nag rp_wcdpd_migration_notice"><h3>Warning!</h3>' . $notice . '<p>Find Out More&nbsp;&nbsp;&nbsp;Contact Support&nbsp;&nbsp;&nbsp;<a href="%s">Hide this notice</a></p></div>', add_query_arg('rp_wcdpd_hide_migration_notice_2021_09_security', '1'));
...
add_action('init', array('RP_WCDPD_Settings', 'get_instance'), 1);
