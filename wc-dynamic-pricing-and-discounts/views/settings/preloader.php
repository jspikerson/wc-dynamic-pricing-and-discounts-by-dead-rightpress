...
<div id="rp_wcdpd_preloader">
    <div id="rp_wcdpd_preloader_content">
        ...
        <p class="rp_wcdpd_preloader_text">
            <?php esc_html_e('This plugin uses a JavaScript-driven user interface. If this notice does not disappear in a few seconds, you should check Console for any JavaScript errors.', 'rp_wcdpd'); ?><br>
        </p>
